...
*/
api.get("/usuarios/:id/detalhes", (req, res) => {
...
api.get("/feiras/:idFeira/estandes", (req, res) => {
	res.send(melhoresFeiras.feiras[req.params.idFeira - 1].estandes);
})
...
api.get("/feiras/:idFeira/noticias", (req, res) => {
    res.send(melhoresFeiras.feiras[req.params.idFeira - 1].noticias);
})
